...
## Purpose
Definir el ciclo completo de comunicaciones salientes con preview obligatorio, cola asíncrona, aprobación configurable, worker idempotente y auditoría segura por tenant.
## Requirements
